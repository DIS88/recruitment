...
## 手工注册信号处理器
# @receiver(signal=post_delete, sender=Resume, dispatch_uid="resume_post_delete_dispatcher") 等同
post_delete.connect(post_delete_callback, sender=Resume, dispatch_uid="resume_post_delete_dispatcher")
post_delete.connect(post_delete_callback, sender=Job, dispatch_uid="Job_post_delete_dispatcher")